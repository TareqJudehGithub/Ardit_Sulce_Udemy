...
They are parts of a builtin module. To use those objects the module needs to 
be imported first. E.g.:
"""
import time
time.sleep(5)
...
# Third-party libraries are packages or modules written by third-party persons 
# (not the Python core development team).
