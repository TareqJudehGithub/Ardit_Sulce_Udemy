...
Sometimes you might need to convert between different data types in
Python for one reason or another. That is very easy to do:
...
that can be understood by the new data type. For example, the following would 
not work:
"""
